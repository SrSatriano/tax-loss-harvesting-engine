...
1. Envie descrição detalhada para o mantenedor via GitHub Security Advisories ou contato privado do repositório [tax-loss-harvesting-engine](https://github.com/SrSatriano/tax-loss-harvesting-engine).
