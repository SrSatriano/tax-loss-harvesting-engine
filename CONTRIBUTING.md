...
Obrigado por considerar uma contribuição para **Motor de tax-loss harvesting**.

## Como começar

1. Faça um fork do repositório [tax-loss-harvesting-engine](https://github.com/SrSatriano/tax-loss-harvesting-engine).
